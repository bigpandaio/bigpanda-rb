...
module BigPanda
  ...
  # Can be constructed from a Hash with the used :access_token or from a file by passing the file location
  #
  class Client
    ...
    def initialize(options = {})
      ...
      options['access_token'] ||= options[:access_token] # Take the string or symbol key

      file = options.delete(:file) || options.delete('file')
